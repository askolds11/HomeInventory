...
fun CustomSearchBar(
    ...
    val heightInt = { appBarsObject.scrollBehavior.topBarState.heightOffset.roundToInt() }
    ...
    SearchBar(
        ...
        onActiveChange,
        modifier
            .offset { IntOffset(x = 0, y = heightInt()) }, // offset outside screen (x = 0.dp, y = heightDp)
        enabled,
        placeholder,
        leadingIcon,
        trailingIcon,
...
fun CustomTopAppBar(
    ...
    TopAppBar(
        title,
        modifier
            .offset { IntOffset(x = 0, y = heightInt()) }, // offset outside screen
        navigationIcon,
        actions,
        windowInsets,
        colors,
